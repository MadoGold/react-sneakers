...

        {
          ...
          :
            <div className="cartEmpty d-flex align-center justify-center flex-column flex">
              <img className="mb-20" src={"/img/empty-cart.jpg"} width={120} height={120} alt="empty-cart"/>
              <h2>Корзина пустая</h2>
              <p className="opacity-6">Добавьте хотя бы ещё одну пару кроссовок, чтобы сделать заказ</p>
